...
Revision ID: d271fa37deb2
Revises: 
Create Date: 2022-05-02 09:30:16.073648
...
def upgrade():
    ...
    sa.Column('birth_month', sa.Date(), nullable=True),
    ...
    op.create_table('athlete_anonymous',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=20), nullable=True),
    sa.Column('added_by', sa.Integer(), nullable=False),
    sa.Column('added_in', sa.Integer(), nullable=False),
    sa.Column('created', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['added_by'], ['athlete.id'], ),
    sa.ForeignKeyConstraint(['added_in'], ['game.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('game_anonym_goalies',
    sa.Column('anonym_id', sa.Integer(), nullable=False),
    sa.Column('game_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['anonym_id'], ['athlete_anonymous.id'], ),
    sa.ForeignKeyConstraint(['game_id'], ['game.id'], ),
    sa.PrimaryKeyConstraint('anonym_id', 'game_id')
    )
    op.create_table('game_anonym_players',
    sa.Column('anonym_id', sa.Integer(), nullable=False),
    sa.Column('game_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['anonym_id'], ['athlete_anonymous.id'], ),
    sa.ForeignKeyConstraint(['game_id'], ['game.id'], ),
    ...
    op.create_table('game_anonym_referees',
    sa.Column('anonym_id', sa.Integer(), nullable=False),
    sa.Column('game_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['anonym_id'], ['athlete_anonymous.id'], ),
    sa.ForeignKeyConstraint(['game_id'], ['game.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('game_anonym_referees')
    op.drop_table('game_anonym_players')
    op.drop_table('game_anonym_goalies')
    op.drop_table('game_referees')
    op.drop_table('game_players')
    op.drop_table('game_organizers')
    op.drop_table('game_goalies')
    op.drop_table('athlete_anonymous')
    op.drop_table('game')
